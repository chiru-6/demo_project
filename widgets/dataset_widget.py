"""Dataset widget module for viewing and filtering raw test data.

This widget provides a table view with filters for exploring the dataset.
"""
...
class DatasetWidget(QWidget):
    ...
    def __init__(self, db) -> None:
        """Initializes the dataset widget.
    ...
    def refresh_data(self) -> None:
        """Refreshes data from database and updates filters + table."""
        try:
